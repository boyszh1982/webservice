package com.asiainfo.bdx.dsrv.client.withoutspring;
...
public class TestClient {
	...
	public static void main(String[] args) {
		...
		outProps.put(WSHandlerConstants.USER, "admin_1");
		...
		// 设置ws访问地址
		factory.setAddress("http://localhost:8080/dsrv/ws/WebServiceSample");
		// 注入拦截器，用于加密安全验证信息
		factory.getOutInterceptors().addAll(list);
		Hello service = (Hello) factory.create();
		String response = service.sayHello("2012");
